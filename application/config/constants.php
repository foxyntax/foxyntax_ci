...
|
| @author: FOXYNTAX
| @description: use ACCESS_CONTROL_ALLOW_ORIGIN to change client code in server.
|
*/
defined('ACCESS_CONTROL_ALLOW_ORIGIN')  OR define('ACCESS_CONTROL_ALLOW_ORIGIN', 'Access-Control-Allow-Origin: http://localhost:8080');
